...
class Estimator
{
  public:
    ...
    void processImage(const map<int, vector<pair<int, Eigen::Matrix<double, 5, 1>>>> &image, const map<int, vector<pair<int, Eigen::Matrix<double, 8, 1>>>> &lines, const std_msgs::Header &header);

    void processImage(const map<int, vector<pair<int, Eigen::Matrix<double, 5, 1>>>> &image,  const std_msgs::Header &header);
