...
bool FeatureManager::addFeatureCheckParallax(int frame_count, const map<int, vector<pair<int, Eigen::Matrix<double, 5, 1>>>> &image, const map<int, vector<pair<int, Eigen::Matrix<double, 8, 1>>>> &lines)
{
    ROS_DEBUG("input point feature: %d", (int)image.size());
